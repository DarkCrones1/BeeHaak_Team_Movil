...
class ProductCandyProvider extends ChangeNotifier {
  ...
  Future fetchProductCandy() async{
    final response = await http.get(Uri.parse('http://localhost:5042/API_Bee_Haak/Product/Category?category=Candy'));
